...
import rhosigchi_f2py_origvar
import numpy as np 

print rhosigchi_f2py_origvar.__doc__
...
something = rhosigchi_f2py_origvar.rhosigchi(fg_reformatted.T, calib, Eg_min, Ex_min, Ex_max)