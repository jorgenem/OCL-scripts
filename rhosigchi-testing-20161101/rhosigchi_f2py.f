...
CJEM      WRITE(6,*)' ________________________________________'
CJEM      WRITE(6,*)'|                                        |'
CJEM      WRITE(6,*)'|         R H O S I G C H I  1.5.3       |'
CJEM      WRITE(6,*)'|                                        |'
CJEM      WRITE(6,*)'|  Program to calculate level density    |'
CJEM      WRITE(6,*)'| Rho, and gamma strength function Sig   |'
CJEM      WRITE(6,*)'| from first-generation spectra, using   |'
CJEM      WRITE(6,*)'|   FgNorm(Ex,Eg)=Rho(Ex-Eg)*Sig(Eg)     |'
CJEM      WRITE(6,*)'|                                        |'
CJEM      WRITE(6,*)'|      Oslo Cyclotron Laboratory         |'
CJEM      WRITE(6,*)'|                                        |'
CJEM      WRITE(6,*)'|        Created: 13/08 - 1999           |'
CJEM      WRITE(6,*)'|           Andreas Schiller             |'
CJEM      WRITE(6,*)'|  Lisbeth Bergholt, Magne Guttormsen    |'
CJEM      WRITE(6,*)'|                                        |'
CJEM      WRITE(6,*)'|        Improved: 01/05 - 2003          |'
CJEM      WRITE(6,*)'|           Alexander Voinov             |'
CJEM      WRITE(6,*)'|  Magne Guttormsen, Andreas Schiller    |'
CJEM      WRITE(6,*)'|        Dubna, Oslo, Livermore          |'
CJEM      WRITE(6,*)'|  Modified 28 Mar 2014: Ex < 0 MeV      |'
CJEM      WRITE(6,*)'|  Modified 13 Feb 2015: One ch shift,   |'
CJEM      WRITE(6,*)'|  ch ig < 0, cut igmax                  |'
CJEM      WRITE(6,*)'|  Modified 31 Aug 2015: No normalization|'
CJEM      WRITE(6,*)'|  Modified 15 Dec 2015: input > 10**-06 |'
CJEM      WRITE(6,*)'|  Modified 11 Feb 2016: new Ydim, Xdim  |'
CJEM      WRITE(6,*)'|  REAL->REAL*8 precision, smooth 300 keV|'
CJEM      WRITE(6,*)'|________________________________________|'
...
C     Calculate new calibration coefficients to get 120 keV bins:
      a1=ABS(aEx1)
...
C Compressing (or stretching) along X and Y - axis
      ...
      DO j=0,YDIM-1
         DO i=0,XDIM-1
CJEM  Make all Fg entries non-zero (should sFg_in get same tratment?)
...
CJEM  Removed a lot of convergence test indicators. Check original
CJEM  rhosigchi.f if they are wanted.
